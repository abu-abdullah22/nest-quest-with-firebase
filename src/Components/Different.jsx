const Different = () => {
    return (
        ...
        <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
            <h1 className="text-4xl font-semibold leading-none text-center">What our customers are saying about how we are different</h1>
        </div>
        <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
            <div className="flex flex-col items-center mx-12 lg:mx-0">
                <div className="relative text-center">
                    ...
                    <p className="px-6 py-1 text-lg italic">Smooth process, expert guidance, found my dream home within budget. Highly recommend for exceptional service and professionalism</p>
                ...
                <p className="font-medium">- Michael Jenkins</p>
            </div>
            <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
                <div className="relative text-center">
                    ...
                    <p className="px-6 py-1 text-lg italic">Valued client support, sold quickly at a great price. Expertise, innovative marketing. Grateful for professionalism, would enlist again.</p>
